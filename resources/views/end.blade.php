<x-app-layout>
    ...
    <div class="flex flex-col justify-center items-center p-8 h-screen">
        <div class="bg-white shadow-sm rounded-lg z-20 mx-10 p-2">
            <img src="{{asset('images/logo_escape.png')}}" alt="logo" class="m-auto w-40 p-5">
            <h1 class="text-center text-3xl font-black">¡ENHORABUENA! Habéis conseguido juntaros, ¡por fin!</h1>
            <p class="p-5 italic text-center">La extraña y fría realidad en la que se encontraba Java era un portal que se creó hace muchos años después de un desastre tecnológico en el centro a través del espejo. De ahí que todo lo que había en ese lado se viese del revés. Se había vuelto a abrir y por eso Django tampoco encontraba a nadie desde su lado. Habían desalojado el centro y no os había llegado el comunicado de la dirección. Gracias a vosotros, se ha podido volver a cerrar y tener otra vez a Java de vuelta.</p>
        </div>
        <div class="flex flex-col space-y-4 p-10 z-20">
